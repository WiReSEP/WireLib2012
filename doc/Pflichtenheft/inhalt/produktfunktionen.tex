...
\subsection{F101 (Anbindung an die UB)}
\begin{description}
    %% TODO:
...
\begin{description}
  ...
  \item[Beschreibung]
    ...
    \end{enumerate}
    %% TODO: Erweiterungen immer automatisch optional oder muss extra gekennzeichnet werden?
...
\begin{description}
  ...
  \item[Beschreibung]
    \begin{enumerate}
      \item Der Benuter gibt seine Ausdruck ein. Einzelne Ausdrücke werden durch ein Leerzeichen getrennt, um der Trennung zu entgehen müssen die Ausdrücke mit einfachen oder doppelten Hochkommata zu einem Ausdruck zusammen gefasst werden. Mehrere Ausdrücke können mit \emph{and} und \emph{or} oder mit \emph{und} und \emph{oder} verknüpft werden.
      \item Der Benutzer bestätigt seine Eingabe.
      \item Das System durchsucht seine Datenbank um Literatureinträge mit den eingegebenen Teilworten zu finden.
      \item Das System gibt eine Seite zurück die alle passenden Einträge anzeigt.
    \end{enumerate}
...
\begin{description}
    %%TODO: Ist auf alle Fälle fristgebunden.
  \item[Geschäftsprozess]
  \item[Ziel]
  \item[Vorbedingung]
  \item[Nachbedingung Erfolg]
...
\begin{description}
    %% TODO: 	-ausschreiben.
    %%		-extrene über anmeldung oder über „verwalter“?
  \item[Geschäftsprozess]
  \item[Ziel]
  \item[Vorbedingung]
  \item[Nachbedingung Erfolg]
...
\begin{description}
    %%TODO: - email an Benutzer und Verwalter?
  \item[Geschäftsprozess]
  \item[Ziel]
  \item[Vorbedingung]
  \item[Nachbedingung Erfolg]
