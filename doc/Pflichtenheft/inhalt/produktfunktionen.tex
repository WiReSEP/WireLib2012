...
\subsection{F221 (Ausleihe externe)}
\begin{description}
...
\begin{description}
  ...
  \item[Beschreibung]Die gewählten Dokumente werden in das Allegro-Format der U\,B konvertiert und übermittelt.
  \item[Erweiterung]
  \item[Alternativen]
\end{description}
