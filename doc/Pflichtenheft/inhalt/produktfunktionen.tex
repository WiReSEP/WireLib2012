...
\begin{description}
  ...
  \item[Beschreibung]\hfill
    \begin{enumerate}
      ...
      \item Der Benutzer wählt eine Option \emph{verloren melden}.
...
\begin{description}
  ...
  \item Der derzeitig Ausleihende wird angezeigt.
  \end{enumerate}
  \item[Erweiterung]
  \item[Alternativen]
\end{description}
...
\begin{description}
  ...
  \item[Beschreibung]\hfill
    ...
    \end{enumerate}
  \item[Erweiterung]Wie auch in \nameref{F:sort} beschrieben, hat der Benutzer die Möglichkeit diese Liste zu sortieren.
  \item[Alternativen]
\end{description}
