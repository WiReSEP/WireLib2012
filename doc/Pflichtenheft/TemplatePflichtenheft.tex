...
\newcommand{\BibTeX}{\gls{glos:BibTeX}}
...
\include{inhalt/zielbestimmung}            % Kapitel 1
\include{inhalt/produkteinsatz}            % Kapitel 2
\include{inhalt/produktuebersicht}         % Kapitel 3
\include{inhalt/produktfunktionen}         % Kapitel 4
\include{inhalt/produktdaten}              % Kapitel 4
\include{inhalt/nichtfunktionaleanforderungen}        % Kapitel 4
\include{inhalt/benutzeroberflaeche}       % Kapitel 4
\include{inhalt/produktumgebung}           % Kapitel 4
