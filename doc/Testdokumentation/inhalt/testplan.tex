...
Im folgenden werden alle zu testenden Funktionen vorgestellt. Diese Funktionen
...
\begin{description}
\item[/F103/] Mailtexte ändern %Jörn
\item[/F200/] \BibTex - Import %Theo
\item[/F201/] Webinterface - Import %Phil
\item[/F202/] Editieren von Dokumenten %Marco
...
\item[/F224/] Ausleihe vermisst melden %Jörn
\item[/F225/] Ausleihe verloren melden %Stephan
\item[/F226/] Ausleihfrist abgelaufen %Stephan
\item[/F227/] Ausleihhistory %Phil
\item[/F228/] Derzeitiger Leihender %Markus
\item[/F229/] Entleihliste %Johann 
\item[/F230/] \BibTex - Export %Theo
\item[/F231/] Universitätsbibliotheks - Export %Phil
\end{description}
...
für alle Tests bereitsgestellt. Als Clienten werden verschiedene Windows- und 
