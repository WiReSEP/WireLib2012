...
\newglossaryentry{glos:https}{name=HTTPS,
description={Hypertext Transfer Protocol Secure (HTTPS) ist die verschlüsselte Variante
vom Hypertext Transfer Protocol und ist eine zertifikatsbasierende sichere
Übertragungstechnik}
}
\newglossaryentry{glos:ssl}{name=SSL,
description={Secure Sockets Layer (SSL) ist ein hybrides Verschlüsselungsprotokoll
